...
script_mod! {
    ...
    mod.themes.dark = {
        ...
        // Type scale, tied to font_size_base and font_size_contrast.
        type_title_l_size: theme.font_size_base + 2.0 * theme.font_size_contrast
        type_title_m_size: theme.font_size_base + 1.0 * theme.font_size_contrast
        type_title_s_size: theme.font_size_base + 0.5 * theme.font_size_contrast
        type_body_l_size: theme.font_size_base + 0.4 * theme.font_size_contrast
        type_body_m_size: theme.font_size_base
        type_body_s_size: theme.font_size_base - 0.4 * theme.font_size_contrast
        type_label_l_size: theme.font_size_base
        type_label_m_size: theme.font_size_base - 0.4 * theme.font_size_contrast
        type_label_s_size: theme.font_size_base - 0.8 * theme.font_size_contrast
        font_size_5: theme.font_size_base + 0.66 * theme.font_size_contrast
        font_size_6: theme.font_size_base + 0.33 * theme.font_size_contrast
        // Sizes and the upper spacing rungs.
        size_control_s: 4. * theme.space_factor
        size_control_m: 5. * theme.space_factor
        size_control_l: 6. * theme.space_factor
        size_icon_s: 12.
        size_icon_m: 16.
        size_icon_l: 24.
        ...
        size_focus_ring: 2.
        size_divider: 1.
        space_4: 2.0 * theme.space_factor
        space_5: 3.0 * theme.space_factor
        space_6: 4.0 * theme.space_factor
        // END DESIGN TOKENS
        ...
        // DESIGN TOKENS
        // Accent roles, generated by theme_tokens::roles_for(Scheme::Dark) from
        // the hue of color_makepad; a unit test regenerates and compares them.
        color_primary: #xE6A294FF
        color_on_primary: #x4A1C11FF
        color_primary_container: #x6E372BFF
        color_on_primary_container: #xF7DAD4FF
        color_secondary: #xD3C5A6FF
        color_on_secondary: #x3E331EFF
        color_secondary_container: #x5F533AFF
        color_on_secondary_container: #xEFE9DCFF
        color_tertiary: #x9CB1DEFF
        ...
        color_warning_container: #x7A5F1FFF
        color_on_warning_container: #xFDEFCEFF
        color_success: #x98E1B1FF
        color_on_success: #x154725FF
        color_success_container: #x2F6A43FF
        color_on_success_container: #xD6F5E0FF
        color_info: #x8EBAEBFF
        color_on_info: #x0E2C4EFF
        color_info_container: #x274A72FF
        color_on_info_container: #xD2E4F9FF
        ...
        color_inverse_on_surface: theme.color_opaque_d_5
        // Elevation shadow colours, one per step.
        color_elevation_1: #x00000059
        color_elevation_2: #x00000066
        color_elevation_3: #x00000073
        color_elevation_4: #x00000080
        color_elevation_5: #x0000008C
        ...
        color_placeholder: theme.color_opaque_u_1
        color_placeholder_hl: theme.color_opaque_u_2
        // END DESIGN TOKENS
