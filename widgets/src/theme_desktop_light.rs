...
script_mod! {
    ...
    mod.themes.light = {
        ...
        // DESIGN TOKENS
        // Accent roles, generated by theme_tokens::roles_for(Scheme::Light) from
        // the hue of color_makepad; a unit test regenerates and compares them.
        color_primary: #xA53D27FF
        color_on_primary: #xFFFFFFFF
        color_primary_container: #xF7DAD4FF
        color_on_primary_container: #x32120CFF
        color_secondary: #x897243FF
        color_on_secondary: #xFFFFFFFF
        color_secondary_container: #xEFE9DCFF
        color_on_secondary_container: #x292214FF
        color_tertiary: #x335499FF
        color_on_tertiary: #xFFFFFFFF
        color_tertiary_container: #xD8E1F3FF
        color_on_tertiary_container: #x0F192EFF
        ...
        color_info_container: #xD2E4F9FF
        color_on_info_container: #x091D34FF
        color_inverse_primary: #xE6A294FF
        ...
        color_inverse_on_surface: theme.color_opaque_u_6
        // Elevation shadow colours, one per step.
        color_elevation_1: #x00000026
        color_elevation_2: #x00000033
        color_elevation_3: #x00000040
        color_elevation_4: #x0000004D
        color_elevation_5: #x00000059
        ...
        color_placeholder: theme.color_opaque_d_1
        color_placeholder_hl: theme.color_opaque_d_2
        // END DESIGN TOKENS
